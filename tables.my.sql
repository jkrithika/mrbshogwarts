...
(
  */The first four fields are required. Dont remove. */
  id        int NOT NULL auto_increment,
  ...
  Area Name      varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci,
  Room Names      varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci,
  PRIMARY KEY (id),
  UNIQUE KEY uq_name (name)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


CREATE TABLE mrbs_capabilities
(
  */The first four fields are required. Dont remove. */
  C_ID        int NOT NULL auto_increment,
  capabilities      varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci,
  PRIMARY KEY (C_ID),
  UNIQUE KEY uq_name (capabilities)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
